...
QIzlezniFakturiKorekcija::QIzlezniFakturiKorekcija(QWidget *parent)
...
void QIzlezniFakturiKorekcija::pressF9()
{
	on_pushButton_4_clicked();
}


QIzlezniFakturiKorekcija::~QIzlezniFakturiKorekcija()
{

}
void QIzlezniFakturiKorekcija::pressEscape()
{
...
void QIzlezniFakturiKorekcija::on_pushButton_clicked()
{
...
void QIzlezniFakturiKorekcija::on_pushButtonA_clicked()
{
	int stop = 0;
	emit scallIspratnici((QWidget*)this, "");
}

void QIzlezniFakturiKorekcija::setFocusLine()
{
    ui.lineEdit->setFocus();
}
void QIzlezniFakturiKorekcija::setKomintent(QString text, QString textName)
{
...
void QIzlezniFakturiKorekcija::setArtikli(QString text, QString textName, QString textKomintentId)
{
...
void QIzlezniFakturiKorekcija::setSaldo(QString text)
{
    ui.lineEdit_6->setText(text);
}

void QIzlezniFakturiKorekcija::setProdCena(QString text)
{
	ui.lineEdit_3->setText(text);
	m_staraCena = text;
}

void QIzlezniFakturiKorekcija::setNabCena(QString text)
{
	m_staraNabCena = text;
}


void QIzlezniFakturiKorekcija::setFocusLine2()
{
    ui.lineEdit_2->setFocus();
}

void QIzlezniFakturiKorekcija::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QIzlezniFakturiKorekcija::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzlezniFakturiKorekcija::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzlezniFakturiKorekcija::on_pushButton_6_clicked()
{
...
void QIzlezniFakturiKorekcija::pressReturn()
{
...
void QIzlezniFakturiKorekcija::init(int id)
{
...
void QIzlezniFakturiKorekcija::on_pushButton_5_clicked()
{
    pressEscape();
}

void QIzlezniFakturiKorekcija::on_pushButton_4_clicked()
{
    ...
    try
    {
		...
		QMessageBox msgBox;
		msgBox.setText(tr("Фактурата е успешно корегирана."));
		msgBox.setStandardButtons(QMessageBox::Ok);
		msgBox.setDefaultButton(QMessageBox::Ok);
		msgBox.exec();
		pressEscape();
...
bool QIzlezniFakturiKorekcija::existDok(int idDok)
{
    int nCount = 0;
...
bool QIzlezniFakturiKorekcija::eventFilter(QObject *object, QEvent *event)
{
...
void QIzlezniFakturiKorekcija::on_plineEdit3_Pressed()
{
    ui.lineEdit_7->setFocus();
	ui.lineEdit_7->selectAll();
}
void QIzlezniFakturiKorekcija::on_plineEdit4_Pressed()
{
...
void QIzlezniFakturiKorekcija::on_plineEdit7_Pressed()
{
	on_pushButton_3_clicked();
}

void QIzlezniFakturiKorekcija::on_plineEdit8_Pressed()
{
...
void QIzlezniFakturiKorekcija::openEditor()
{
...
void QIzlezniFakturiKorekcija::closeEditor()
{
    ui.tableView->closePersistentEditor(indexPrev);
}

bool QIzlezniFakturiKorekcija::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QIzlezniFakturiKorekcija::calculateIznosi()
{
	QLocale loc;
	CHelperClass chc(this);
	int rows = model->rowCount();
