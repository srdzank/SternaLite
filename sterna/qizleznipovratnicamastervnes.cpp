...
QIzleznipovratnicamasterVnes::QIzleznipovratnicamasterVnes(QWidget *parent)
...
void QIzleznipovratnicamasterVnes::pressF9()
{
	on_pushButton_4_clicked();
}


void QIzleznipovratnicamasterVnes::pressEscape()
{
    emit closeW();
}
void QIzleznipovratnicamasterVnes::setKomintent(QString text, QString textName)
{
    ui.lineEdit->setText(textName);
    komintentID = text;
}

void QIzleznipovratnicamasterVnes::setFocusLine()
{
    ui.lineEdit->setFocus();
    ui.lineEdit->selectAll();
}

void QIzleznipovratnicamasterVnes::on_pushButtonA_clicked()
{
	int stop = 0;
	emit scallpovratnicamaster((QWidget*)this, "");
}

void QIzleznipovratnicamasterVnes::setArtikli(QString text, QString textName, QString textKomintentId)
{
...
void QIzleznipovratnicamasterVnes::setSaldo(QString text)
{
    ui.lineEdit_5->setText(text);
}

void QIzleznipovratnicamasterVnes::setProdCena(QString text)
{
	ui.lineEdit_3->setText(text);
	m_staraCena = text;
}

void QIzleznipovratnicamasterVnes::setNabCena(QString text)
{
	m_staraNabCena = text;
}


void QIzleznipovratnicamasterVnes::setFocusLine2()
{
...
void QIzleznipovratnicamasterVnes::on_pushButton_clicked()
{
...
void QIzleznipovratnicamasterVnes::lineEditPressReturn()
{
    emit scallKomintenti((QWidget*)this, ui.lineEdit->text());
}

void QIzleznipovratnicamasterVnes::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QIzleznipovratnicamasterVnes::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzleznipovratnicamasterVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzleznipovratnicamasterVnes::on_pushButton_6_clicked()
{
...
void QIzleznipovratnicamasterVnes::pressReturn()
{
...
void QIzleznipovratnicamasterVnes::on_pushButton_4_clicked()
{
	...
	QMessageBox msgBox;
	msgBox.setText(tr("ПОВРАТНИЦАТА ке биде ВНЕСЕНА"));
    ...
    try
    {
        ...
        QMessageBox msgBox;
        msgBox.setText(tr("Повратницата е успешно внесена."));
        msgBox.setStandardButtons(QMessageBox::Ok);
        msgBox.setDefaultButton(QMessageBox::Ok);
        msgBox.exec();
        pressEscape();
    ...
    catch (...)
    {
        ...
        QMessageBox msgBox;
        msgBox.setText(tr("Повратницата не е внесена !!!."));
        msgBox.setStandardButtons(QMessageBox::Ok);
        msgBox.setDefaultButton(QMessageBox::Ok);
        msgBox.exec();
    }
...
void QIzleznipovratnicamasterVnes::on_pushButton_5_clicked()
{
    pressEscape();
}


bool QIzleznipovratnicamasterVnes::existDok(int idDok)
{
    int nCount = 0;
...
bool QIzleznipovratnicamasterVnes::eventFilter(QObject *object, QEvent *event)
{
...
void QIzleznipovratnicamasterVnes::on_plineEdit3_Pressed()
{
    ui.lineEdit_6->setFocus();
}
void QIzleznipovratnicamasterVnes::on_plineEdit4_Pressed()
{
...
void QIzleznipovratnicamasterVnes::on_plineEdit6_Pressed()
{
        on_pushButton_3_clicked();
}

void QIzleznipovratnicamasterVnes::on_plineEdit7_Pressed()
{
...
void QIzleznipovratnicamasterVnes::openEditor()
{
...
void QIzleznipovratnicamasterVnes::closeEditor()
{
...
QIzleznipovratnicamasterVnes::~QIzleznipovratnicamasterVnes()
{

}

bool QIzleznipovratnicamasterVnes::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QIzleznipovratnicamasterVnes::calculateIznosi()
{
	QLocale loc;
