...
QIzlezniprofakturimasterVnes::QIzlezniprofakturimasterVnes(QWidget *parent)
...
void QIzlezniprofakturimasterVnes::pressF9()
{
	on_pushButton_4_clicked();
}


void QIzlezniprofakturimasterVnes::pressEscape()
{
    emit closeW();
}
void QIzlezniprofakturimasterVnes::setKomintent(QString text, QString textName)
{
    ui.lineEdit->setText(textName);
    komintentID = text;
}

void QIzlezniprofakturimasterVnes::setFocusLine()
{
    ui.lineEdit->setFocus();
    ui.lineEdit->selectAll();
}

void QIzlezniprofakturimasterVnes::on_pushButtonA_clicked()
{
	int stop = 0;
	emit scallprofakturimaster((QWidget*)this, "");
}

void QIzlezniprofakturimasterVnes::setArtikli(QString text, QString textName, QString textKomintentId)
{
...
void QIzlezniprofakturimasterVnes::setSaldo(QString text)
{
    ui.lineEdit_5->setText(text);
}

void QIzlezniprofakturimasterVnes::setProdCena(QString text)
{
	ui.lineEdit_3->setText(text);
	m_staraCena = text;
}

void QIzlezniprofakturimasterVnes::setNabCena(QString text)
{
	m_staraNabCena = text;
}


void QIzlezniprofakturimasterVnes::setFocusLine2()
{
...
void QIzlezniprofakturimasterVnes::on_pushButton_clicked()
{
...
void QIzlezniprofakturimasterVnes::lineEditPressReturn()
{
    emit scallKomintenti((QWidget*)this, ui.lineEdit->text());
}

void QIzlezniprofakturimasterVnes::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QIzlezniprofakturimasterVnes::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzlezniprofakturimasterVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzlezniprofakturimasterVnes::on_pushButton_6_clicked()
{
...
void QIzlezniprofakturimasterVnes::pressReturn()
{
...
void QIzlezniprofakturimasterVnes::on_pushButton_4_clicked()
{
	...
	QMessageBox msgBox;
	msgBox.setText(tr("ПРОФАКТУРАТА ке биде ВНЕСЕНА"));
...
void QIzlezniprofakturimasterVnes::on_pushButton_5_clicked()
{
    pressEscape();
}


bool QIzlezniprofakturimasterVnes::existDok(int idDok)
{
    int nCount = 0;
...
bool QIzlezniprofakturimasterVnes::eventFilter(QObject *object, QEvent *event)
{
...
void QIzlezniprofakturimasterVnes::on_plineEdit3_Pressed()
{
    ui.lineEdit_6->setFocus();
}
void QIzlezniprofakturimasterVnes::on_plineEdit4_Pressed()
{
...
void QIzlezniprofakturimasterVnes::on_plineEdit6_Pressed()
{
        on_pushButton_3_clicked();
}

void QIzlezniprofakturimasterVnes::on_plineEdit7_Pressed()
{
...
void QIzlezniprofakturimasterVnes::openEditor()
{
...
void QIzlezniprofakturimasterVnes::closeEditor()
{
...
QIzlezniprofakturimasterVnes::~QIzlezniprofakturimasterVnes()
{

}

bool QIzlezniprofakturimasterVnes::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QIzlezniprofakturimasterVnes::calculateIznosi()
{
	QLocale loc;
