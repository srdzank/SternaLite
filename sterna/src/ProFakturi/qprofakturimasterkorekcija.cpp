...
QIzlezniprofakturimasterKorekcija::QIzlezniprofakturimasterKorekcija(QWidget *parent)
...
void QIzlezniprofakturimasterKorekcija::pressF9()
{
	on_pushButton_4_clicked();
}


QIzlezniprofakturimasterKorekcija::~QIzlezniprofakturimasterKorekcija()
{

}
void QIzlezniprofakturimasterKorekcija::pressEscape()
{
...
void QIzlezniprofakturimasterKorekcija::on_pushButton_clicked()
{
...
void QIzlezniprofakturimasterKorekcija::on_pushButtonA_clicked()
{
	int stop = 0;
	emit scallprofakturimaster((QWidget*)this, "");
}

void QIzlezniprofakturimasterKorekcija::setFocusLine()
{
    ui.lineEdit->setFocus();
}
void QIzlezniprofakturimasterKorekcija::setKomintent(QString text, QString textName)
{
    ui.lineEdit->setText(textName);
    komintentID = text;
}

void QIzlezniprofakturimasterKorekcija::setArtikli(QString text, QString textName, QString textKomintentId)
{
...
void QIzlezniprofakturimasterKorekcija::setSaldo(QString text)
{
    ui.lineEdit_6->setText(text);
}

void QIzlezniprofakturimasterKorekcija::setProdCena(QString text)
{
	ui.lineEdit_3->setText(text);
	m_staraCena = text;
}

void QIzlezniprofakturimasterKorekcija::setNabCena(QString text)
{
	m_staraNabCena = text;
}


void QIzlezniprofakturimasterKorekcija::setFocusLine2()
{
    ui.lineEdit_2->setFocus();
}

void QIzlezniprofakturimasterKorekcija::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QIzlezniprofakturimasterKorekcija::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzlezniprofakturimasterKorekcija::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzlezniprofakturimasterKorekcija::on_pushButton_6_clicked()
{
...
void QIzlezniprofakturimasterKorekcija::pressReturn()
{
...
void QIzlezniprofakturimasterKorekcija::init(int id)
{
    ...
    QString temp1 = 
        ...
        "where dokumenti.dok_tip = 150 and dokumenti.dok_id = ";        
	...
	QString temp = 
		...
		"where magacin.dok_tip = 150 and magacin.dok_id=       ";
...
void QIzlezniprofakturimasterKorekcija::on_pushButton_5_clicked()
{
    pressEscape();
}

void QIzlezniprofakturimasterKorekcija::on_pushButton_4_clicked()
{
	...
	QMessageBox msgBox;
	msgBox.setText(tr("ПРОФАКТУРАТА ке биде КОРЕГИРАНА"));
    ...
    QSqlQuery query1;
    query1.clear();
    query1.prepare("update dokumenti set dok_id = :a0, datum=:a1, faktura_id=:a2, mag_id=:a3, komintent_id=:a4 , rok=:a5, zabeleska =:a6, valuta_datum =:a7 where id=:aid and dok_tip = 150");
    ...
    query1.clear();
    query1.prepare(
        "delete from magacin where dok_tip = 150 and dok_id = :a"
        );
    query1.bindValue(":a", mmid);	
    query1.exec();
    try
    {
        QString temp = "select max(dok_id) from dokumenti where dok_tip = 150";
        QSqlQuery query;
		...
		QMessageBox msgBox;
		msgBox.setText(tr("Про-Фактурата е успешно корегирана."));
		msgBox.setStandardButtons(QMessageBox::Ok);
		msgBox.setDefaultButton(QMessageBox::Ok);
		msgBox.exec();
		pressEscape();
	...
	catch (...)
	{
        ...
        QMessageBox msgBox;
        msgBox.setText(tr("ПроФактурата не е корегирана !!!."));
        msgBox.setStandardButtons(QMessageBox::Ok);
        msgBox.setDefaultButton(QMessageBox::Ok);
        msgBox.exec();
    }
}
bool QIzlezniprofakturimasterKorekcija::existDok(int idDok)
{
    int nCount = 0;
    QString temp = "select count(dok_id) br from dokumenti where dok_tip = 150 and dok_id =";
...
bool QIzlezniprofakturimasterKorekcija::eventFilter(QObject *object, QEvent *event)
{
...
void QIzlezniprofakturimasterKorekcija::on_plineEdit3_Pressed()
{
    ui.lineEdit_7->setFocus();
	ui.lineEdit_7->selectAll();
}
void QIzlezniprofakturimasterKorekcija::on_plineEdit4_Pressed()
{
...
void QIzlezniprofakturimasterKorekcija::on_plineEdit7_Pressed()
{
	on_pushButton_3_clicked();
}

void QIzlezniprofakturimasterKorekcija::on_plineEdit8_Pressed()
{
...
void QIzlezniprofakturimasterKorekcija::openEditor()
{
...
void QIzlezniprofakturimasterKorekcija::closeEditor()
{
    ui.tableView->closePersistentEditor(indexPrev);
}

bool QIzlezniprofakturimasterKorekcija::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QIzlezniprofakturimasterKorekcija::calculateIznosi()
{
	QLocale loc;
	CHelperClass chc(this);
	int rows = model->rowCount();
