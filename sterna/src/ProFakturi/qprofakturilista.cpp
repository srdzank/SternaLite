#include "qvlezniprofakturi.h"

#include <QSqlQuery>
#include <QSqlRecord>

QVlezniProFakturiLista::QVlezniProFakturiLista(QWidget *parent)
...
QVlezniProFakturiLista::~QVlezniProFakturiLista()
{

}
void QVlezniProFakturiLista::pressEscape()
{
	emit closeW();
}
void QVlezniProFakturiLista::lista(const QString& nameSearch)
{
...
void QVlezniProFakturiLista::selectionChanged(QModelIndex modelX, QModelIndex modelY)
{
	int i = modelX.row();
...
void QVlezniProFakturiLista::lista_detail(const QString& nameSearch)
{
	if (nameSearch.length() < 0)
	{
//		ui.tableView_2->hide();
