...
QIzjavaVnes::QIzjavaVnes(QWidget *parent)
...
QIzjavaVnes::~QIzjavaVnes()
{

}


void QIzjavaVnes::on_pushButton_clicked()
{
...
void QIzjavaVnes::pressEscape()
{
	emit closeW();
}

void QIzjavaVnes::pressF9()
{
	on_pushButton_4_clicked();
}

void QIzjavaVnes::setKomintent(QString text, QString textName)
{
	ui.lineEdit->setText(textName);
    komintentID = text;
}

void QIzjavaVnes::setFocusLine()
{
	ui.lineEdit->setFocus();
}

void QIzjavaVnes::setArtikli(QString text, QString textName)
{
...
void QIzjavaVnes::on_pushButton_2_clicked()
{
	CHelperClass hclass(this);
...
void QIzjavaVnes::setFocusLine2()
{
	ui.lineEdit_2->setFocus();
}

void QIzjavaVnes::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzjavaVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
	selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzjavaVnes::on_pushButton_6_clicked()
{
	model->removeRow(selRow);
}
void QIzjavaVnes::pressReturn()
{
...
void QIzjavaVnes::on_pushButton_4_clicked()
{
   ...
   if (!query.lastError().isValid())
	{
		...
		for (int i = 0; i < rows; i++)
		{
			...
			query.bindValue(":a1", m_id);	
			query.bindValue(":a2", 21);  // vnes na priemnici 	
...
bool QIzjavaVnes::existDok(int idDok)
{
    int nCount = 0;
...
bool QIzjavaVnes::eventFilter(QObject *object, QEvent *event)
{
...
void QIzjavaVnes::on_plineEdit3_Pressed()
{
    ui.lineEdit_4->setFocus();
}
void QIzjavaVnes::on_plineEdit4_Pressed()
{
    on_pushButton_3_clicked();
}
void QIzjavaVnes::openEditor()
{
...
void QIzjavaVnes::closeEditor()
{
    ui.tableView->closePersistentEditor(indexPrev);
}

void QIzjavaVnes::on_pushButton_5_clicked()
{
	pressEscape();
}

bool QIzjavaVnes::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
