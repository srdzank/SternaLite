...
QOdobrenieVnes::QOdobrenieVnes(QWidget *parent)
...
void QOdobrenieVnes::pressF9()
{
	on_pushButton_4_clicked();
}


void QOdobrenieVnes::pressEscape()
{
    emit closeW();
}
void QOdobrenieVnes::setKomintent(QString text, QString textName)
{
    ui.lineEdit->setText(textName);
    komintentID = text;
}

void QOdobrenieVnes::setFocusLine()
{
    ui.lineEdit->setFocus();
    ui.lineEdit->selectAll();
}

void QOdobrenieVnes::setArtikli(QString text, QString textName)
{
...
void QOdobrenieVnes::setSaldo(QString text)
{
    ui.lineEdit_5->setText(text);
}

void QOdobrenieVnes::setFocusLine2()
{
...
void QOdobrenieVnes::on_pushButton_clicked()
{
...
void QOdobrenieVnes::lineEditPressReturn()
{
    emit scallKomintenti((QWidget*)this, ui.lineEdit->text());
}

void QOdobrenieVnes::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QOdobrenieVnes::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QOdobrenieVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QOdobrenieVnes::on_pushButton_6_clicked()
{
    model->removeRow(selRow);
}
void QOdobrenieVnes::pressReturn()
{
...
void QOdobrenieVnes::on_pushButton_4_clicked()
{
    ...
    try
    {
        ...
        query.clear();
        query.prepare("insert into dokumenti(dok_id, dok_tip, datum, faktura_id, mag_id, komintent_id, rok, zabeleska) values(:a1,:a2,:a3,:a4,:a5,:a6,:a7,:a8)");
...
void QOdobrenieVnes::on_pushButton_5_clicked()
{
    pressEscape();
}


bool QOdobrenieVnes::existDok(int idDok)
{
    int nCount = 0;
...
bool QOdobrenieVnes::eventFilter(QObject *object, QEvent *event)
{
...
void QOdobrenieVnes::on_plineEdit3_Pressed()
{
    ui.lineEdit_4->setFocus();
}
void QOdobrenieVnes::on_plineEdit4_Pressed()
{
...
void QOdobrenieVnes::on_plineEdit6_Pressed()
{
        on_pushButton_3_clicked();
}

void QOdobrenieVnes::openEditor()
{
...
void QOdobrenieVnes::closeEditor()
{
...
QOdobrenieVnes::~QOdobrenieVnes()
{

}

bool QOdobrenieVnes::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
