...
QIzleznipopismasterKorekcija::QIzleznipopismasterKorekcija(QWidget *parent)
...
void QIzleznipopismasterKorekcija::pressF9()
{
	on_pushButton_4_clicked();
}


QIzleznipopismasterKorekcija::~QIzleznipopismasterKorekcija()
{

}
void QIzleznipopismasterKorekcija::pressEscape()
{
...
void QIzleznipopismasterKorekcija::on_pushButton_clicked()
{
...
void QIzleznipopismasterKorekcija::on_pushButtonA_clicked()
{
	int stop = 0;
	emit scallpopismaster((QWidget*)this, "");
}

void QIzleznipopismasterKorekcija::setFocusLine()
{
    ui.lineEdit->setFocus();
}
void QIzleznipopismasterKorekcija::setKomintent(QString text, QString textName)
{
    ui.lineEdit->setText(textName);
    komintentID = text;
}

void QIzleznipopismasterKorekcija::setArtikli(QString text, QString textName, QString textKomintentId)
{
...
void QIzleznipopismasterKorekcija::setSaldo(QString text)
{
    ui.lineEdit_6->setText(text);
}

void QIzleznipopismasterKorekcija::setProdCena(QString text)
{
	ui.lineEdit_3->setText(text);
	m_staraCena = text;
}

void QIzleznipopismasterKorekcija::setNabCena(QString text)
{
	m_staraNabCena = text;
}


void QIzleznipopismasterKorekcija::setFocusLine2()
{
    ui.lineEdit_2->setFocus();
}

void QIzleznipopismasterKorekcija::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QIzleznipopismasterKorekcija::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzleznipopismasterKorekcija::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzleznipopismasterKorekcija::on_pushButton_6_clicked()
{
...
void QIzleznipopismasterKorekcija::pressReturn()
{
...
void QIzleznipopismasterKorekcija::init(int id)
{
    ...
    QString temp1 = 
        ...
        "where dokumenti.dok_tip = 80 and dokumenti.dok_id = ";        
...
void QIzleznipopismasterKorekcija::on_pushButton_5_clicked()
{
    pressEscape();
}

void QIzleznipopismasterKorekcija::on_pushButton_4_clicked()
{
	...
	QMessageBox msgBox;
	msgBox.setText(tr("ПОПИСОТ ке биде КОРЕГИРАН"));
    ...
    QSqlQuery query1;
    query1.clear();
    query1.prepare("update dokumenti set dok_id = :a0, datum=:a1, faktura_id=:a2, mag_id=:a3, komintent_id=:a4 , rok=:a5, zabeleska =:a6, valuta_datum =:a7 where id=:aid and dok_tip = 80");
    ...
    try
    {
		...
		QMessageBox msgBox;
		msgBox.setText(tr("Пописот е успешно корегиран."));
		msgBox.setStandardButtons(QMessageBox::Ok);
		msgBox.setDefaultButton(QMessageBox::Ok);
		msgBox.exec();
		pressEscape();
	...
	catch (...)
	{
        ...
        QMessageBox msgBox;
        msgBox.setText(tr("Пописот не е корегиран !!!."));
        msgBox.setStandardButtons(QMessageBox::Ok);
        msgBox.setDefaultButton(QMessageBox::Ok);
        msgBox.exec();
    }
}
bool QIzleznipopismasterKorekcija::existDok(int idDok)
{
    int nCount = 0;
...
bool QIzleznipopismasterKorekcija::eventFilter(QObject *object, QEvent *event)
{
...
void QIzleznipopismasterKorekcija::on_plineEdit3_Pressed()
{
    ui.lineEdit_7->setFocus();
	ui.lineEdit_7->selectAll();
}
void QIzleznipopismasterKorekcija::on_plineEdit4_Pressed()
{
...
void QIzleznipopismasterKorekcija::on_plineEdit7_Pressed()
{
	on_pushButton_3_clicked();
}

void QIzleznipopismasterKorekcija::on_plineEdit8_Pressed()
{
...
void QIzleznipopismasterKorekcija::openEditor()
{
...
void QIzleznipopismasterKorekcija::closeEditor()
{
    ui.tableView->closePersistentEditor(indexPrev);
}

bool QIzleznipopismasterKorekcija::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QIzleznipopismasterKorekcija::calculateIznosi()
{
	QLocale loc;
	CHelperClass chc(this);
	int rows = model->rowCount();
