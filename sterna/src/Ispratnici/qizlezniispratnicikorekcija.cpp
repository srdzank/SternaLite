...
QIzlezniIspratniciKorekcija::QIzlezniIspratniciKorekcija(QWidget *parent)
...
void QIzlezniIspratniciKorekcija::pressF9()
{
	on_pushButton_4_clicked();
}


QIzlezniIspratniciKorekcija::~QIzlezniIspratniciKorekcija()
{
	setTableColumnWidths(15);
}


void QIzlezniIspratniciKorekcija::procSectionResized(int a, int b, int c)
{
	colWidth[a] = c;
}

void QIzlezniIspratniciKorekcija::pressEscape()
{
...
void QIzlezniIspratniciKorekcija::on_pushButton_clicked()
{
...
void QIzlezniIspratniciKorekcija::on_pushButtonA_clicked()
{
	int stop = 0;
	emit scallIspratnici((QWidget*)this, "");
}

void QIzlezniIspratniciKorekcija::setFocusLine()
{
    ui.lineEdit->setFocus();
}
void QIzlezniIspratniciKorekcija::setKomintent(QString text, QString textName)
{
...
void QIzlezniIspratniciKorekcija::setArtikli(QString text, QString textName, QString textKomintentId)
{
...
void QIzlezniIspratniciKorekcija::setSaldo(QString text)
{
    ui.lineEdit_6->setText(text);
}

void QIzlezniIspratniciKorekcija::setProdCena(QString text)
{
	ui.lineEdit_3->setText(text);
	m_staraCena = text;
}

void QIzlezniIspratniciKorekcija::setNabCena(QString text)
{
	m_staraNabCena = text;
}


void QIzlezniIspratniciKorekcija::setFocusLine2()
{
    ui.lineEdit_2->setFocus();
}

void QIzlezniIspratniciKorekcija::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QIzlezniIspratniciKorekcija::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzlezniIspratniciKorekcija::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzlezniIspratniciKorekcija::on_pushButton_6_clicked()
{
...
void QIzlezniIspratniciKorekcija::pressReturn()
{
...
void QIzlezniIspratniciKorekcija::init(int id)
{
...
void QIzlezniIspratniciKorekcija::on_pushButton_5_clicked()
{
    pressEscape();
}

void QIzlezniIspratniciKorekcija::on_pushButton_4_clicked()
{
	...
	QMessageBox msgBox;
	msgBox.setText(tr("ИСПРАТНИЦАТА ке биде КОРЕГИРАНА"));
    ...
    QSqlQuery query1;
    query1.clear();
    query1.prepare("update dokumenti set dok_id = :a0, datum=:a1, faktura_id=:a2, mag_id=:a3, komintent_id=:a4 , rok=:a5, zabeleska =:a6, valuta_datum =:a7 where id=:aid and dok_tip = 60");
    ...
    try
    {
		...
		QMessageBox msgBox;
		msgBox.setText(tr("Испратницата е успешно корегирана."));
		msgBox.setStandardButtons(QMessageBox::Ok);
		msgBox.setDefaultButton(QMessageBox::Ok);
		msgBox.exec();
		pressEscape();
	...
	catch (...)
	{
        ...
        QMessageBox msgBox;
        msgBox.setText(tr("Испратницата не е корегирана !!!."));
        msgBox.setStandardButtons(QMessageBox::Ok);
        msgBox.setDefaultButton(QMessageBox::Ok);
        msgBox.exec();
    }
}
bool QIzlezniIspratniciKorekcija::existDok(int idDok)
{
    int nCount = 0;
...
bool QIzlezniIspratniciKorekcija::eventFilter(QObject *object, QEvent *event)
{
...
void QIzlezniIspratniciKorekcija::on_plineEdit3_Pressed()
{
    ui.lineEdit_7->setFocus();
	ui.lineEdit_7->selectAll();
}
void QIzlezniIspratniciKorekcija::on_plineEdit4_Pressed()
{
...
void QIzlezniIspratniciKorekcija::on_plineEdit7_Pressed()
{
	on_pushButton_3_clicked();
}

void QIzlezniIspratniciKorekcija::on_plineEdit8_Pressed()
{
...
void QIzlezniIspratniciKorekcija::openEditor()
{
...
void QIzlezniIspratniciKorekcija::closeEditor()
{
    ui.tableView->closePersistentEditor(indexPrev);
}

bool QIzlezniIspratniciKorekcija::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QIzlezniIspratniciKorekcija::calculateIznosi()
{
	QLocale loc;
	CHelperClass chc(this);
	int rows = model->rowCount();
...
void QIzlezniIspratniciKorekcija::setTableColumnWidths(int ccolumn)
{
	Singleton *s = Singleton::Instance();
	...
	s->setIspratnicaKorekcija_ColumnWidth(tempWidth);
}

void QIzlezniIspratniciKorekcija::getTableColumnWidths(int ccolumn)
{
	QLocale loc;
	Singleton *s = Singleton::Instance();
	QStringList sss = s->getIspratnicaKorekcija_ColumnWidth();
