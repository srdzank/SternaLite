...
QPovratnicaVnes::QPovratnicaVnes(QWidget *parent)
    ...
    , editorOpen(0)
{
	...
	connect(ui.lineEdit_8, SIGNAL(returnPressed()), this, SLOT(on_pushButton_clickedFakturiIzlezni()));
...
void QPovratnicaVnes::pressEscape()
{
    emit closeW();
}
void QPovratnicaVnes::setKomintent(QString text, QString textName)
{
    ui.lineEdit->setText(textName);
    komintentID = text;
}

void QPovratnicaVnes::setFocusLine()
{
    ui.lineEdit->setFocus();
    ui.lineEdit->selectAll();
}
void QPovratnicaVnes::setFocusLine3()
{
	ui.lineEdit_7->setFocus();
	ui.lineEdit_7->selectAll();
}

void QPovratnicaVnes::setArtikli(QString text, QString textName)
{
...
void QPovratnicaVnes::setSaldo(QString text)
{
    ui.lineEdit_5->setText(text);
}

void QPovratnicaVnes::setFocusLine2()
{
...
void QPovratnicaVnes::on_pushButton_clickedFakturiIzlezni()
{
	emit scallFakturi((QWidget*)this, ui.lineEdit->text());
}

void QPovratnicaVnes::on_pushButton_clicked()
{
...
void QPovratnicaVnes::lineEditPressReturn()
{
    emit scallKomintenti((QWidget*)this, ui.lineEdit->text());
}

void QPovratnicaVnes::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QPovratnicaVnes::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QPovratnicaVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QPovratnicaVnes::on_pushButton_6_clicked()
{
    model->removeRow(selRow);
}
void QPovratnicaVnes::pressReturn()
{
...
void QPovratnicaVnes::on_pushButton_4_clicked()
{
    ...
    try
    {
        ...
        query.clear();
        query.prepare("insert into dokumenti(dok_id, dok_tip, datum, faktura_id, mag_id, komintent_id, rok, zabeleska, user_id) values(:a1,:a2,:a3,:a4,:a5,:a6,:a7,:a8,:a9)");
		...
		query.bindValue(":a1", m_id);	
		query.bindValue(":a2", QString::number(m_iznosvraten, 'f', 2));	
		query.bindValue(":a3", ui.lineEdit_8->text());	
		query.exec();
...
void QPovratnicaVnes::on_pushButton_5_clicked()
{
    pressEscape();
}


bool QPovratnicaVnes::existDok(int idDok)
{
    int nCount = 0;
...
bool QPovratnicaVnes::eventFilter(QObject *object, QEvent *event)
{
...
void QPovratnicaVnes::on_plineEdit3_Pressed()
{
    ui.lineEdit_4->setFocus();
}
void QPovratnicaVnes::on_plineEdit4_Pressed()
{
...
void QPovratnicaVnes::on_plineEdit6_Pressed()
{
        on_pushButton_3_clicked();
}

void QPovratnicaVnes::openEditor()
{
...
void QPovratnicaVnes::closeEditor()
{
...
QPovratnicaVnes::~QPovratnicaVnes()
{

}

bool QPovratnicaVnes::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QPovratnicaVnes::setFakturi(QStringList& listData)
{
	if(listData.size())
	{
		QStringList rowData = listData.at(0).split(" :: ");
		m_faktura_id = rowData.at(1).trimmed();
		ui.lineEdit_8->setText(m_faktura_id);
		ui.lineEdit_7->setFocus();
	}
}
