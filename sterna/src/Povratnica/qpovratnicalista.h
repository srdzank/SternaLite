...
public:
    ...
    ~QPovratnicaLista();
    void lista(const QString& nameSearch, const QDateTime &date1, const QDateTime &date2);
...
signals:
        ...
        void procF2();
        void procF3();
        void sPovratnicaToIzvod(const QString& text6, const QString& text8, const QString& text9, const QString& textName);
};
