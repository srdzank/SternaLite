...
namespace {
struct qt_meta_tag_ZN26QAnalitikaKomintentiWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN26QAnalitikaKomintentiWidgetE = QtMocHelpers::stringData(
    "QAnalitikaKomintentiWidget",
    "closeW",
    "",
    "sAnalitikaKomintentiToDokument",
    "QString&",
    "text",
    "textName",
    "textNameSaldo",
...
Q_CONSTINIT static const uint qt_meta_data_ZN26QAnalitikaKomintentiWidgetE[] = {
...
Q_CONSTINIT const QMetaObject QAnalitikaKomintentiWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QMyBaseFormWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN26QAnalitikaKomintentiWidgetE.offsetsAndSizes,
    qt_meta_data_ZN26QAnalitikaKomintentiWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN26QAnalitikaKomintentiWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QAnalitikaKomintentiWidget, std::true_type>,
        // method 'closeW'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'sAnalitikaKomintentiToDokument'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
{
    auto *_t = static_cast<QAnalitikaKomintentiWidget *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->closeW(); break;
        case 1: _t->sAnalitikaKomintentiToDokument((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QAnalitikaKomintentiWidget::*)();
            if (_q_method_type _q_method = &QAnalitikaKomintentiWidget::closeW; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QAnalitikaKomintentiWidget::*)(QString & , QString & , QString & );
            if (_q_method_type _q_method = &QAnalitikaKomintentiWidget::sAnalitikaKomintentiToDokument; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QAnalitikaKomintentiWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN26QAnalitikaKomintentiWidgetE.stringdata0))
