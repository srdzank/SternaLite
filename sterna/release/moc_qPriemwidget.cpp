...
namespace {
struct qt_meta_tag_ZN12QPriemWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12QPriemWidgetE = QtMocHelpers::stringData(
    "QPriemWidget",
    "closeW",
    "",
    "sPriemToDokument",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12QPriemWidgetE[] = {
...
Q_CONSTINIT const QMetaObject QPriemWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QMyBaseFormWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN12QPriemWidgetE.offsetsAndSizes,
    qt_meta_data_ZN12QPriemWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12QPriemWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QPriemWidget, std::true_type>,
        // method 'closeW'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'sPriemToDokument'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
{
    auto *_t = static_cast<QPriemWidget *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->closeW(); break;
        case 1: _t->sPriemToDokument((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QPriemWidget::*)();
            if (_q_method_type _q_method = &QPriemWidget::closeW; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QPriemWidget::*)(QString & , QString & , QString & );
            if (_q_method_type _q_method = &QPriemWidget::sPriemToDokument; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QPriemWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12QPriemWidgetE.stringdata0))
