...
namespace {
struct qt_meta_tag_ZN13QEmployeListaE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13QEmployeListaE = QtMocHelpers::stringData(
    "QEmployeLista",
    "closeW",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13QEmployeListaE[] = {
...
Q_CONSTINIT const QMetaObject QEmployeLista::staticMetaObject = { {
    QMetaObject::SuperData::link<QMyBaseFormWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN13QEmployeListaE.offsetsAndSizes,
    qt_meta_data_ZN13QEmployeListaE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13QEmployeListaE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QEmployeLista, std::true_type>,
        // method 'closeW'
...
{
    auto *_t = static_cast<QEmployeLista *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QEmployeLista::*)();
            if (_q_method_type _q_method = &QEmployeLista::closeW; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QEmployeLista::*)(QString & , QString & );
            if (_q_method_type _q_method = &QEmployeLista::sKomintentToPriemnica; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QEmployeLista::*)();
            if (_q_method_type _q_method = &QEmployeLista::procF2; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (QEmployeLista::*)();
            if (_q_method_type _q_method = &QEmployeLista::procF3; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *QEmployeLista::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13QEmployeListaE.stringdata0))
