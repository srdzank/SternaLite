...
namespace {
struct qt_meta_tag_ZN13QMyKomintentiE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13QMyKomintentiE = QtMocHelpers::stringData(
    "QMyKomintenti",
    "signCloseMyWidget",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13QMyKomintentiE[] = {
...
Q_CONSTINIT const QMetaObject QMyKomintenti::staticMetaObject = { {
    QMetaObject::SuperData::link<QMyBaseWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN13QMyKomintentiE.offsetsAndSizes,
    qt_meta_data_ZN13QMyKomintentiE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13QMyKomintentiE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QMyKomintenti, std::true_type>,
...
{
    auto *_t = static_cast<QMyKomintenti *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QMyKomintenti::*)();
            if (_q_method_type _q_method = &QMyKomintenti::signCloseMyWidget; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QMyKomintenti::*)();
            if (_q_method_type _q_method = &QMyKomintenti::eCloseKomintentiFromPriemnica; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QMyKomintenti::*)(QWidget * , QWidget * );
            if (_q_method_type _q_method = &QMyKomintenti::eupdateNanigator; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QMyKomintenti::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13QMyKomintentiE.stringdata0))
