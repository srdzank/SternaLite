...
namespace {
struct qt_meta_tag_ZN17QAnalitikaArtikliE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17QAnalitikaArtikliE = QtMocHelpers::stringData(
    "QAnalitikaArtikli",
    "signCloseMyWidget",
    "",
    ...
    "QWidget*",
    "closeWLista",
    "callretAnalitikaArtikliToDokument",
    "QString&",
    "text",
    "textName",
    "textNameSaldo",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17QAnalitikaArtikliE[] = {
...
Q_CONSTINIT const QMetaObject QAnalitikaArtikli::staticMetaObject = { {
    QMetaObject::SuperData::link<QMyBaseWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN17QAnalitikaArtikliE.offsetsAndSizes,
    qt_meta_data_ZN17QAnalitikaArtikliE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17QAnalitikaArtikliE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QAnalitikaArtikli, std::true_type>,
        ...
        // method 'closeWLista'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'callretAnalitikaArtikliToDokument'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
{
    auto *_t = static_cast<QAnalitikaArtikli *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->callretAnalitikaArtikliToDokument((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QAnalitikaArtikli::*)();
            if (_q_method_type _q_method = &QAnalitikaArtikli::signCloseMyWidget; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QAnalitikaArtikli::*)();
            if (_q_method_type _q_method = &QAnalitikaArtikli::eCloseKomintentiFromPriemnica; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QAnalitikaArtikli::*)(QWidget * , QWidget * );
            if (_q_method_type _q_method = &QAnalitikaArtikli::eupdateNanigator; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QAnalitikaArtikli::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17QAnalitikaArtikliE.stringdata0))
