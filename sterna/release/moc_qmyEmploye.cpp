...
namespace {
struct qt_meta_tag_ZN10QMyEmployeE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10QMyEmployeE = QtMocHelpers::stringData(
    "QMyEmploye",
    "signCloseMyWidget",
    "",
    "eCloseEmployeFromPriemnica",
    "eupdateNanigator",
    "QWidget*",
    "succesfulEntryData",
    "closeWLista",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10QMyEmployeE[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      13,    0,   97,    2, 0x0a,   14 /* Public */,
      14,    1,   98,    2, 0x0a,   15 /* Public */,
...
Q_CONSTINIT const QMetaObject QMyEmploye::staticMetaObject = { {
    QMetaObject::SuperData::link<QMyBaseWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN10QMyEmployeE.offsetsAndSizes,
    qt_meta_data_ZN10QMyEmployeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10QMyEmployeE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QMyEmploye, std::true_type>,
        // method 'signCloseMyWidget'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'eCloseEmployeFromPriemnica'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
{
    auto *_t = static_cast<QMyEmploye *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->retKomintentToPriemnica((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QMyEmploye::*)();
            if (_q_method_type _q_method = &QMyEmploye::signCloseMyWidget; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QMyEmploye::*)();
            if (_q_method_type _q_method = &QMyEmploye::eCloseEmployeFromPriemnica; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QMyEmploye::*)(QWidget * , QWidget * );
            if (_q_method_type _q_method = &QMyEmploye::eupdateNanigator; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QMyEmploye::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10QMyEmployeE.stringdata0))
