...
namespace {
struct qt_meta_tag_ZN20QFinAnalitKomintentiE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN20QFinAnalitKomintentiE = QtMocHelpers::stringData(
    ...
    "QWidget*",
    "closeWLista",
    "callretFinAnalitKomintentiToDokument",
    "QString&",
    "text",
    "textName",
    "textNameSaldo",
...
Q_CONSTINIT static const uint qt_meta_data_ZN20QFinAnalitKomintentiE[] = {
...
Q_CONSTINIT const QMetaObject QFinAnalitKomintenti::staticMetaObject = { {
    QMetaObject::SuperData::link<QMyBaseWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN20QFinAnalitKomintentiE.offsetsAndSizes,
    qt_meta_data_ZN20QFinAnalitKomintentiE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20QFinAnalitKomintentiE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QFinAnalitKomintenti, std::true_type>,
        ...
        // method 'closeWLista'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'callretFinAnalitKomintentiToDokument'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
{
    auto *_t = static_cast<QFinAnalitKomintenti *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->callretFinAnalitKomintentiToDokument((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QFinAnalitKomintenti::*)();
            if (_q_method_type _q_method = &QFinAnalitKomintenti::signCloseMyWidget; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QFinAnalitKomintenti::*)();
            if (_q_method_type _q_method = &QFinAnalitKomintenti::eCloseKomintentiFromPriemnica; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QFinAnalitKomintenti::*)(QWidget * , QWidget * );
            if (_q_method_type _q_method = &QFinAnalitKomintenti::eupdateNanigator; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QFinAnalitKomintenti::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20QFinAnalitKomintentiE.stringdata0))
