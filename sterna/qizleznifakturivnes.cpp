...
void QIzlezniFakturiVnes::pressF9()
{
	on_pushButton_4_clicked();
}


void QIzlezniFakturiVnes::pressEscape()
{
    emit closeW();
}
void QIzlezniFakturiVnes::setKomintent(QString text, QString textName)
{
    ui.lineEdit->setText(textName);
    komintentID = text;
}

void QIzlezniFakturiVnes::setFocusLine()
{
    ui.lineEdit->setFocus();
    ui.lineEdit->selectAll();
}

void QIzlezniFakturiVnes::on_pushButtonA_clicked()
{
	int stop = 0;
	emit scallIspratnici((QWidget*)this, "");
}

void QIzlezniFakturiVnes::setArtikli(QString text, QString textName, QString textKomintentId)
{
...
void QIzlezniFakturiVnes::setSaldo(QString text)
{
    ui.lineEdit_5->setText(text);
}

void QIzlezniFakturiVnes::setProdCena(QString text)
{
	ui.lineEdit_3->setText(text);
	m_staraCena = text;
}

void QIzlezniFakturiVnes::setNabCena(QString text)
{
	m_staraNabCena = text;
}


void QIzlezniFakturiVnes::setFocusLine2()
{
...
void QIzlezniFakturiVnes::on_pushButton_clicked()
{
...
void QIzlezniFakturiVnes::lineEditPressReturn()
{
    emit scallKomintenti((QWidget*)this, ui.lineEdit->text());
}

void QIzlezniFakturiVnes::on_pushButton_2_clicked()
{
    CHelperClass hclass(this);
...
void QIzlezniFakturiVnes::on_pushButton_3_clicked()
{
	CHelperClass hclass(this);
	if (!hclass.isArtikliExists(ui.lineEdit_2->text()))
	{
...
void QIzlezniFakturiVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    selRow = modelX.row();
    editorOpen = false;
    emit closeCell();
...
void QIzlezniFakturiVnes::on_pushButton_6_clicked()
{
...
void QIzlezniFakturiVnes::pressReturn()
{
...
void QIzlezniFakturiVnes::on_pushButton_4_clicked()
{
...
void QIzlezniFakturiVnes::on_pushButton_5_clicked()
{
    pressEscape();
}


bool QIzlezniFakturiVnes::existDok(int idDok)
{
    int nCount = 0;
...
bool QIzlezniFakturiVnes::eventFilter(QObject *object, QEvent *event)
{
...
void QIzlezniFakturiVnes::on_plineEdit3_Pressed()
{
    ui.lineEdit_6->setFocus();
}
void QIzlezniFakturiVnes::on_plineEdit4_Pressed()
{
...
void QIzlezniFakturiVnes::on_plineEdit6_Pressed()
{
        on_pushButton_3_clicked();
}

void QIzlezniFakturiVnes::on_plineEdit7_Pressed()
{
...
void QIzlezniFakturiVnes::openEditor()
{
...
void QIzlezniFakturiVnes::closeEditor()
{
...
QIzlezniFakturiVnes::~QIzlezniFakturiVnes()
{

}

bool QIzlezniFakturiVnes::validateKomintent()
{
	bool stat = false;
	CHelperClass hclass(this);
	if (hclass.isKomintentExists(ui.lineEdit->text()))
...
void QIzlezniFakturiVnes::calculateIznosi()
{
	QLocale loc;
