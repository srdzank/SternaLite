/********************************************************************************
** Form generated from reading UI file 'qmykomintenti.ui'
**
...
#ifndef UI_QMYKOMINTENTI_H
#define UI_QMYKOMINTENTI_H
...
class Ui_QMyKomintentiClass
{
public:

    void setupUi(QMyBaseWidget *QMyKomintentiClass)
    {
        if (QMyKomintentiClass->objectName().isEmpty())
            QMyKomintentiClass->setObjectName("QMyKomintentiClass");
        QMyKomintentiClass->resize(806, 632);
        QPalette palette;
...
#endif
        QMyKomintentiClass->setPalette(palette);
        QFont font;
        font.setPointSize(10);
        QMyKomintentiClass->setFont(font);
        QMyKomintentiClass->setAutoFillBackground(true);

        retranslateUi(QMyKomintentiClass);

        QMetaObject::connectSlotsByName(QMyKomintentiClass);
    } // setupUi

    void retranslateUi(QMyBaseWidget *QMyKomintentiClass)
    {
        QMyKomintentiClass->setWindowTitle(QCoreApplication::translate("QMyKomintentiClass", "QMyKomintenti", nullptr));
    } // retranslateUi

};

namespace Ui {
    class QMyKomintentiClass: public Ui_QMyKomintentiClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_QMYKOMINTENTI_H
