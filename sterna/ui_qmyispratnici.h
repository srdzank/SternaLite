...
public:
    ...
    void setupUi(QMyBaseWidget *QMyIspratniciClass)
    {
        if (QMyIspratniciClass->objectName().isEmpty())
            QMyIspratniciClass->setObjectName("QMyIspratniciClass");
    ...
    {
        QMyIspratniciClass->setWindowTitle(QCoreApplication::translate("QMyIspratniciClass", "QMyIspratnici", nullptr));
    } // retranslateUi
