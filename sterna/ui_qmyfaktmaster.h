...
public:
    ...
    void setupUi(QMyBaseWidget *QMyfaktmasterClass)
    {
        if (QMyfaktmasterClass->objectName().isEmpty())
            QMyfaktmasterClass->setObjectName("QMyfaktmasterClass");
    ...
    {
        QMyfaktmasterClass->setWindowTitle(QCoreApplication::translate("QMyfaktmasterClass", "QMyfaktmaster", nullptr));
    } // retranslateUi
